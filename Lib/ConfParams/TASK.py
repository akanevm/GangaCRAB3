...
class TASK(GangaObject):
    ...
    schemadic['nonprodsw']       = SimpleItem(defvalue=None, typelist=['type(None)','int'], doc='')
    schemadic['tfileoutfiles']   = SimpleItem(defvalue=[None], typelist=['type(None)','str'], sequence = 1, doc='')
    schemadic['asyncdest']       = SimpleItem(defvalue=None, typelist=['type(None)','str'], doc='')
    schemadic['oneEventMode']    = SimpleItem(defvalue=None, typelist=['type(None)','int'], doc='')
    schemadic['algoargs']        = SimpleItem(defvalue=None, typelist=['type(None)','int'], doc='')
    schemadic['totalunits']      = SimpleItem(defvalue=None, typelist=['type(None)','int'], doc='')
    schemadic['jobarch']         = SimpleItem(defvalue=None, typelist=['type(None)','str'], doc='')
    schemadic['publication']     = SimpleItem(defvalue=None, typelist=['type(None)','int'], doc='')
    schemadic['splitalgo']       = SimpleItem(defvalue=None, typelist=['type(None)','str'], doc='')
    schemadic['jobsw']           = SimpleItem(defvalue=None, typelist=['type(None)','str'], doc='')
    schemadic['dbsurl']          = SimpleItem(defvalue=None, typelist=['type(None)','str'], doc='')
    schemadic['publishdbsurl']   = SimpleItem(defvalue=None, typelist=['type(None)','str'], doc='')
    schemadic['addoutputfiles']  = SimpleItem(defvalue=[None], typelist=['type(None)','str'], sequence = 1, doc='')
    ...
    schemadic['userfiles']       = SimpleItem(defvalue=None, typelist=['type(None)','str'], doc='') 
    ...
    schemadic['userhn']          = SimpleItem(defvalue=None, typelist=['type(None)','str'], doc='')
    schemadic['vorole']          = SimpleItem(defvalue=None, typelist=['type(None)','str'], doc='')
    schemadic['vogroup']         = SimpleItem(defvalue=None, typelist=['type(None)','str'], doc='')
    schemadic['runs']            = SimpleItem(defvalue=[None], typelist=['type(None)','str'], sequence = 1, doc='')
    schemadic['lumis']           = SimpleItem(defvalue=[None], typelist=['type(None)','str'], sequence = 1, doc='')
    schemadic['maxjobruntime']   = SimpleItem(defvalue=None, typelist=['type(None)','int'], doc='')
    schemadic['numcores']        = SimpleItem(defvalue=None, typelist=['type(None)','int'], doc='')
    ...
    schemadic['scheddname']      = SimpleItem(defvalue=None, typelist=['type(None)','str'], doc='')
    schemadic['collector']       = SimpleItem(defvalue=None, typelist=['type(None)','str'], doc='')
